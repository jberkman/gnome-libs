...
extern XCC XCCCreate(TWidget w, TVisual *_visual, TColormap _colormap);

/* copy an XCC entirely */
extern XCC XCCCopy(XCC src);

extern XCC XCCMonoCreate(Display *_dpy, TVisual *_visual, TColormap _colormap);
...
extern TColormap XCCGetColormap(XCC _xcc);
extern TVisual *XCCGetVisual(XCC _xcc);
extern TVisualInfo *XCCGetVisualInfo(XCC _xcc);
extern int XCCGetDepth(XCC _xcc);
extern int XCCGetClass(XCC _xcc);
extern Display *XCCGetDisplay(XCC _xcc);
extern int XCCQueryColor(XCC _xcc, TColor *_color);
extern int XCCQueryColors(XCC _xcc, TColor *_colors, int _numColors);

/*****
* Returns visual of either the widget (or any parent that is a subclass of
* shell) or the default visual
*****/
extern TVisual *XCCGetParentVisual(TWidget w);

/*****
* Add a palette to the given XCC. All colors will then be mapped onto this
* palette.
*****/
extern int XCCAddPalette(XCC _xcc, TColor *palette, int num_palette);
