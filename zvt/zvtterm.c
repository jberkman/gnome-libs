 ...
 * zvt_term_set_blink:
 * @term: the terminal
 * @state: the blking state.  If true, the cursor will blink
 *
 ...
 * @term: the terminal
 * @state: if TRUE, makes the terminal scroll on output
 *         being generated by a child process or by the feed
 *         routine
 */
void 
 ...
 *
 * This sets the color scheme.  Each pointer points to a gushort array
 * of 18 elements.  The elements 1 trough 16 are the first 16 colors.
 *
 * Element 17 is the defualt foreground.
 * Element 18 is the default background.
 */
void
 ...
 * @term: the terminal widget
 * @lines: number of lines desired for the scrollback.
 *
 ...
 * zvt_term_forkpty:
 * @term: the terminal
 * @do_uwtmp_log: If true, it updates uwtmp/wtmp files.
 *
 ...
 * @signal: the signal
 *
 * send the signal SIGNAL to the child process.
 *
 * Returns the value kill system call return value.
 */
