...
create_date_edit (void)
{
	...
	datedit = H_(gnome_date_edit_new(curtime,1,1), "date_edit");
	win = H_(create_newwin(TRUE,"testGNOME","Date Edit"), "date_edit_win");
...
create_druid(void)
{
  ...
  page_start = gnome_druid_page_edge_new_with_vals
    (GNOME_EDGE_START, FALSE, "Beginning of the DRUID",
     ...
     NULL,
     NULL);
  page_a = gnome_druid_page_standard_new_with_vals (FALSE, "Page A", logo, NULL);
  page_b = gnome_druid_page_standard_new_with_vals (FALSE, "Page B", logo, NULL);
  page_c = gnome_druid_page_standard_new_with_vals (FALSE, "Page C", logo, NULL);
  page_d = gnome_druid_page_standard_new_with_vals (FALSE, "Page D", logo, NULL);
  page_e = gnome_druid_page_standard_new_with_vals (FALSE, "Page E", logo, NULL);
  page_f = gnome_druid_page_standard_new_with_vals (FALSE, "Page F", logo, NULL);
  page_g = gnome_druid_page_standard_new_with_vals (FALSE, "Page G", logo, NULL);
